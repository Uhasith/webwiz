...
return new class extends Migration
{
    ...
    {
        Schema::create('anually_weather_data', function (Blueprint $table) {
            ...
            $table->foreignUuid('anually_sensor_data_id')->references('id')->on('anually_sensor_data');
    ...
    {
        Schema::dropIfExists('anually_weather_data');
    }
};
