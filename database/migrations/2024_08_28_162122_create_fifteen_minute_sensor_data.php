...
return new class extends Migration
{
    ...
    {
        Schema::create('fifteen_minute_sensor_data', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('fifteen_minute_sensor_data');
    }
};
//php artisan make:migration add_new_columns_to_your_table_name