...
<template>
  ...
  <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 bg-gray-100">
    <div class="mt-6 px-6 py-4 bg-white border border-gray-200 overflow-hidden sm:rounded-lg md:w-[650px] w-full h-auto opacity-0 md:opacity-100">
      <div class="text-center">
        <img src="/images/logo.png" alt="Centered Image" class="mx-auto h-12 mt-3" />
        <h1 class="text-4xl font-semibold mt-9">Forgot Password</h1>
        ...
        <form @submit.prevent="submitEmail">
          ...
          <div>
            ...
            <TextInput
              ...
              v-model="email"
              type="email"
              class="rounded-2xl text-sm mt-1 w-[550px] px-3 py-1 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent"
              autofocus
          ...
          <div class="flex justify-center items-center mt-8">
            <PrimaryButton
            class="rounded-2xl text-center w-[550px] bg-green1 text-white py-1 rounded-lg hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-opacity-50 flex items-center justify-center text-sm font-normal"
      ...
      <div v-else>
        <ResetPassword 
        @password-reset-success="(message) => { successMessage = message; }" 
    />   
    </div>
