...
class DailySensorDataRepo{

    public function save($data): void
    {
        $sensorData = new DailySensorData();
    ...
    public function saveDailySensorDataList(array $sensorData){
        return DailySensorData::insert($sensorData);
    }

    public function getDailyData($start,$end): \Illuminate\Database\Eloquent\Collection|array
    {

        return DailySensorData::with('weatherRecords')
    ...
    {
        $annuallySensorDataRecords = DailySensorData::where('identifier',$identifier)->where('sensor_location_id',$sensorLocationId)->get();
