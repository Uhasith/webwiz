 ...
 * @property MonthlyWeatherData $monthlyWeatherData
 *
 */
class MonthlySensorData extends Model
{
    /**
     ...
     * @var string
     */
    protected $table = 'monthly_sensor_data';
    ...
    {
        return $this->hasOne('App\ModelsV2\MonthlyWeatherData','monthly_sensor_data_id');
    }
