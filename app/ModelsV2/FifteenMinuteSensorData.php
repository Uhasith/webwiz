 ...
 * @property FifteenMinuteWeatherData $fifteenMinuteWeatherData
 ...
 */
class FifteenMinuteSensorData extends Model
{
     ...
     * @return HasOne
     */
    public function fifteenMinuteWeatherData(): \Illuminate\Database\Eloquent\Relations\HasOne
    {
        return $this->hasOne('App\ModelsV2\FifteenMinuteWeatherData');
    }
